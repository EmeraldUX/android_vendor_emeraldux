...
ALARM_PATH := vendor/emeraldux/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/emeraldux/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/emeraldux/prebuilt/common/media/audio/ringtones
